...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Ver evaluación''.}
\label{fig:seq_ver_eval}
\includegraphics[width=\textwidth]{figuras/seq_ver_eval.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario del caso de uso ``Ver evaluación''.}
\label{fig:iu_ver_eval}
\includegraphics[width=\textwidth]{figuras/ui_evaluaciones_estudiante.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Resolver evaluación''.}
\label{fig:seq_resolver}
\includegraphics[width=0.9\textwidth]{figuras/seq_resolver_eval.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario del caso de uso ``Resolver evaluación'' con apoyo en pictogramas.}
\label{fig:iu_resolver}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Ver retroalimentación''.}
\label{fig:seq_retro}
\includegraphics[width=\textwidth]{figuras/seq_ver_retroalimentacion.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario del caso de uso ``Ver retroalimentación'' con \textit{feedback} de IA.}
\label{fig:iu_retro}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Gestionar panel docente''.}
\label{fig:seq_panel}
\includegraphics[width=\textwidth]{figuras/seq_panel_docente.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario de la gestión de clases del docente.}
\label{fig:iu_panel}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Crear examen''.}
\label{fig:seq_crear_examen}
\includegraphics[width=\textwidth]{figuras/seq_crear_examen.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario del caso de uso ``Crear examen''.}
\label{fig:iu_crear_examen}
\includegraphics[width=\textwidth]{figuras/ui_crear_examen.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Organizar preguntas''.}
\label{fig:seq_organizar}
\includegraphics[width=0.9\textwidth]{figuras/seq_organizar_preguntas.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario del caso de uso ``Organizar preguntas''.}
\label{fig:iu_organizar}
\includegraphics[width=\textwidth]{figuras/ui_nueva_pregunta.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Configurar contenido''.}
\label{fig:seq_configurar}
\includegraphics[width=\textwidth]{figuras/seq_configurar_contenido.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario del caso de uso ``Configurar contenido''.}
\label{fig:iu_configurar}
\includegraphics[width=\textwidth]{figuras/ui_gestionar_opciones.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Adjuntar archivos multimedia''.}
\label{fig:seq_multimedia}
\includegraphics[width=\textwidth]{figuras/seq_adjuntar_multimedia.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario para selección de pictogramas (banco ARASAAC).}
\label{fig:iu_multimedia}
\includegraphics[width=\textwidth]{figuras/ui_arasaac_pictogramas.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Consultar alumnos''.}
\label{fig:seq_alumnos}
\includegraphics[width=\textwidth]{figuras/seq_consultar_alumnos.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario del caso de uso ``Consultar alumnos''.}
\label{fig:iu_alumnos}
\includegraphics[width=\textwidth]{figuras/ui_listado_estudiantes.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Analizar calificaciones''.}
\label{fig:seq_analizar}
\includegraphics[width=\textwidth]{figuras/seq_analizar_calificaciones.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Identificar brechas de aprendizaje''.}
\label{fig:seq_brechas}
\includegraphics[width=\textwidth]{figuras/seq_identificar_brechas.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Recibir consejos IA''.}
\label{fig:seq_consejos}
\includegraphics[width=\textwidth]{figuras/seq_recibir_consejos_ia.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Aplicar gamificación''.}
\label{fig:seq_gamificacion}
\includegraphics[width=\textwidth]{figuras/seq_aplicar_gamificacion.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Ingresar a clase''.}
\label{fig:seq_ingresar}
\includegraphics[width=\textwidth]{figuras/seq_ingresar_clase.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz de usuario para ingresar el ``Código Secreto'' de la clase.}
\label{fig:iu_ingresar_codigo}
\includegraphics[width=\textwidth]{figuras/ui_ingresar_codigo.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Pantalla de pre-evaluación al ingresar a una clase Kiddy Quiz.}
\label{fig:iu_ingresar}
\includegraphics[width=\textwidth]{figuras/ui_pre_evaluacion.pdf}
\fuenteautor
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Diagrama de secuencia del caso de uso ``Ver mapa de competencias''.}
\label{fig:seq_mapa}
\includegraphics[width=\textwidth]{figuras/seq_mapa_competencias.pdf}
\fuenteautor
\end{figure}

\begin{figure}[H]
\centering
\caption{Interfaz ``Mi Mapa de Aventuras'': visualización del progreso por competencias.}
\label{fig:iu_mapa}
\includegraphics[width=\textwidth]{figuras/ui_mapa_aventuras.pdf}
\fuenteautor
\end{figure}
