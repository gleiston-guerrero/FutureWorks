...
\includegraphics[width=0.9\textwidth]{figuras/img_metodologia_xp.png}
\fuente{Adaptado de Pressman \cite{ref47_ganney_xp}}
\end{figure}
...
\begin{figure}[H]
\centering
\caption{Cronograma de actividades del proyecto Kiddy Quiz (32 semanas).}
\label{fig:cronograma}
\includegraphics[width=\textwidth]{figuras/img_cronograma.png}
\fuenteautor
\end{figure}
