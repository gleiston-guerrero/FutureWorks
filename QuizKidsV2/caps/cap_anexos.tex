...
% Comando auxiliar: crea una sección de anexo sin numeración automática
% y la añade manualmente al TOC con el texto completo "Anexo X. Título".
\newcounter{anexocount}
\renewcommand{\theanexocount}{\Alph{anexocount}}
\newcommand{\anexo}[1]{%
  \refstepcounter{anexocount}%
  \section*{Anexo \theanexocount. #1}%
  \addcontentsline{toc}{section}{Anexo \theanexocount. #1}%
}

\anexo{Guion de entrevista a docentes y psicopedagogos}
...
\anexo{Cuestionario SUS aplicado en castellano}
...
\anexo{Cuestionario TAM aplicado en castellano}
...
\anexo{Diagrama completo de casos de uso del sistema}

\begin{figure}[H]
\centering
\caption{Diagrama completo de casos de uso del sistema Kiddy Quiz.}
\label{fig:anexo_cu}
\includegraphics[width=\textwidth]{figuras/img_casos_uso.png}
\fuenteautor
\end{figure}

\anexo{Manual de usuario de la aplicación Kiddy Quiz}
