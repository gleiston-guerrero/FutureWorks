% =====================================================================
%  MEMORANDO TECNICO DE ASPECTOS ETICOS --- Proyecto EAES
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\sffamily\color{grismedio}Memorando t\'ecnico de aspectos \'eticos --- Proyecto EAES}
...
\begin{tabular}{@{}L{5.0cm}@{}L{10.4cm}@{}}
	\textbf{\small Denominaci\'on:} & Escritura acad\'emica y herramientas digitales de apoyo: estudio multic\'entrico sobre procesos de elaboraci\'on de textos y aprendizaje en educaci\'on superior \\
	...
	\textbf{\small Dise\~no:} & Experimental aleatorizado, tres grupos, medidas repetidas \\
	\textbf{\small Participantes previstos:} & Alrededor de 225 estudiantes \\
	\textbf{\small Duraci\'on de la participaci\'on:} & Tres sesiones de dos horas y una sesi\'on de cuarenta minutos \\
...
\vspace{2pt}
\begin{tabular}{@{}L{5.0cm}@{}L{10.4cm}@{}}
	\textbf{\small Fuente de financiamiento:} & \campo{10.2cm} \\
\end{tabular}
