% =====================================================================
%  CONSENTIMIENTO INFORMADO --- Proyecto EAES
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\sffamily\color{grismedio}Consentimiento informado --- Proyecto EAES}
...
El Proyecto EAES estudia c\'omo los estudiantes universitarios elaboran textos acad\'emicos y qu\'e factores influyen en lo que aprenden durante ese proceso. La investigaci\'on se desarrolla simult\'aneamente en varias universidades y es conducida por docentes investigadores de las instituciones participantes.
...
\vspace{4pt}
\begin{recuadro}
\casilla\ \ \textbf{Acepto participar} en el Proyecto EAES en los t\'erminos descritos en este documento.
\end{recuadro}
