...
\vspace{8pt}
\textbf{Asunto:} Solicitud de revisi\'on y aprobaci\'on \'etica del proyecto de investigaci\'on EAES ante el Comit\'e de \'Etica de Investigaci\'on institucional.
...
\begin{recuadro}
\textbf{Denominaci\'on del proyecto:} Escritura acad\'emica y herramientas digitales de apoyo: estudio multic\'entrico sobre procesos de elaboraci\'on de textos y aprendizaje en educaci\'on superior \textbf{(Proyecto EAES)}.
...
\vspace{4pt}
\textbf{Poblaci\'on participante:} Estudiantes de tercer nivel de carreras de computaci\'on y \'areas afines.
\end{recuadro}
...
\vspace{10pt}
{\footnotesize \textit{Copia:} Decanato de la Facultad de Ciencias de la Computaci\'on \textbullet\ Direcci\'on de Investigaci\'on \textbullet\ Archivo.}
