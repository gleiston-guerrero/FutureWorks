...
\begin{document}
	...
	% ---------- T\'itulo --------------------------------------------------
	\title[mode=title]{RutAI: un marco m\'ovil basado en componentes que integra alternancia de rutas con aprendizaje por bandidos, alarmas geolocalizadas y monitoreo colaborativo para una movilidad urbana m\'as segura}
	...
	% ---------- Autores ------------------------------------------------
	% NOTA: los roles CRediT se escriben en ingl\'es (estandar NISO CRediT),
	% evitando caracteres acentuados que causan errores de codificaci\'on
	% al ser expandidos por \printcredits en cas-sc.
