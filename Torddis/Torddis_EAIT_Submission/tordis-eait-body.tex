	...
	\label{section:fourth}
		...
		More specifically, Torddis was developed using the TDDM4IoTS methodology \citep{Guerrero-Ulloa2020TDDM4IoTS}. This methodology is one of the most comprehensive in terms of the system lifecycle \citep{Guerrero2023Agile}, and has been validated and evaluated in various application domains  \citep{Guerrero-Ulloa2020IoT, Guerrero-Ulloa2022Internet, Guerrero-Ulloa2023DevIdeAir, Guerrero-Ulloa2023SP4, Guerrero-Ulloa2023Nawi}. During the development of the proposed system, all stages of the methodology were applied, except the final one—maintenance—due to the system’s short lifespan at the time of writing this article. Furthermore, this methodological framework facilitates early error detection, contributing to reduced costs and development time while enabling cleaner code \citep{Beck2002TDD}.
		...
		\subsection{Preliminary Analysis}
			...
			\subsubsection{Preliminary Requirements Analysis}
				...
				Use case diagrams were employed for the requirement analysis, using the free web tool TDDT4IoTS available at \href{https://aplicaciones.uteq.edu.ec/tddt4iots}{https://aplicaciones.uteq.edu.ec/tddt4iots} and \href{http://www.tddt4iots.com}{http://www.tddt4iots.com}.
                ...
                \begin{enumerate}
                    \item \textbf{Availability:} The component had to be in stock. Since there is no direct local market at the project facilitator’s location, reliable online stores (such as www.mercadolibre.com.ec) were sought.
                ...
                As TDDM4IoTS \citep{Guerrero-Ulloa2020TDDM4IoTS} suggests that not all stages must necessarily be executed, nor in a fixed order, the model refinement stage was not applied.
                ...
                Furthermore, the omission of this stage is also attributable to the tool used—TDDT4IoTS \citep{Guerrero2024Test}—since model refinement is inherently handled within the use cases, with the tool automatically updating the models. Given that the model was generated directly from use case specifications and that Torddis did not involve a complexity level demanding extraordinary modeling efforts, the model produced by TDDT4IoTS was deemed optimal.
                ...
                The software development for the Torddis system was conducted in two main stages: generation and refinement. Initially, the source code was automatically generated by the TDDT4IoTS tool \citep{Guerrero2024Test}, based on models and tests also automatically generated from the use cases that contained the system specifications.
                ...
                The TDDM4IoTS methodology \citep{Guerrero-Ulloa2020TDDM4IoTS} was selected for its focus on IoT projects, enabling iterative hardware–software integration. During Torddis development, this methodology supported:
                ...
                Compared to traditional methodologies, TDDM4IoTS stands out for its adaptability to projects with multiple interdependent deliverables, such as those combining diverse IoT components and mobile applications. Furthermore, it ensures compliance with system lifecycle standards \citep{Guerrero2023Agile,ISO-IEC-IEEE12207-2017,ISO-IEC-IEEE12207-2017Application}.
                ...
                The outcomes obtained enable a comprehensive evaluation of the Torddis system’s performance in domestic settings, providing empirical evidence of its utility as a technological tool for learning support. These results stem from the systematic application of the stages defined in the TDDM4IoTS methodology \citep{Guerrero-Ulloa2020TDDM4IoTS}, whose guided implementation structured the prototype’s development and facilitated the validation of its pedagogical and technical effectiveness.
...
%
                ...
                \begin{itemize} 
                    \item A total of 12 families were evaluated, represented by 8 mothers and 4 fathers, all from the geographic area of Quevedo, Ecuador.
