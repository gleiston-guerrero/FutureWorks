...
\usepackage{array}% For >{...} column-type prefixes and \extrarowheight
\usepackage{tabularx}%
\usepackage{pgfplots}%
\usepackage{tikz}%
...
%% Extra row height to prevent header text from touching table rules
%% (Springer's toprule/midrule use zero baseline space by default)
