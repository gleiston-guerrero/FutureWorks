...
const RASTREO = [
	/^_ga/, /^_gid$/, /^__utm/, /^_gcl_/, /^_gac_/,                    // Google Analytics / Ads
	/^receive-cookie-deprecation$/,                                     // Google Privacy Sandbox
	/^YSC$/, /^VISITOR_INFO/, /^VISITOR_PRIVACY/, /^__Secure-YNID$/,
	/^__Secure-ROLLOUT/, /^IDE$/, /^test_cookie$/, /^DSID$/,            // YouTube / DoubleClick
	/^_fbp$/, /^_fbc$/, /^fr$/,                                         // Meta
	/^_tt_/, /^_ttp$/, /^ttcsid/,                                       // TikTok
	/^_clck$/, /^_clsk$/, /^MUID$/, /^MR$/, /^SM$/, /^SRM_B$/,
	/^ANONCHK$/, /^CLID$/,                                              // Microsoft Clarity / Ads
	/^_uet/,                                                            // Bing UET
	/^bcookie$/, /^bscookie$/, /^lidc$/, /^li_sugr$/, /^li_gc$/,
	/^UserMatchHistory$/, /^AnalyticsSyncHistory$/,                     // LinkedIn Insight
	/^TapAd_/, /^sa-user-id/,                                           // TapAd / StackAdapt
	/^_scid/, /^sc_at$/,                                                // Snapchat
	/^muc_ads$/, /^personalization_id$/, /^_twpid$/,                    // X / Twitter
	/^_hj/, /^nmstat$/, /^_pk_/, /^pys/, /^sbjs_/, /^_pin_/,            // Hotjar, Siteimprove, Matomo...
	/^AMCV_/, /^s_/, /^utag/, /^mbox/, /^_cs_/,                         // Adobe / Tealium / ContentSquare
	/^Hm_lvt_/, /^Hm_lpvt_/, /^HMACCOUNT/, /^BAIDUID$/,                 // Baidu
	/^__qca$/, /^ln_or$/, /^_lc2_/                                      // Quantcast / LiveIntent
];
