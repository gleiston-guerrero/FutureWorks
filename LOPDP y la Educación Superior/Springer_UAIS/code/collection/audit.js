 ...
 *  ---------------------------------------------------------------------------
 *  Recolecta, para cada universidad de "universities.json", evidencia REAL y
 ...
 *  Escribe los results de forma incremental (resistente a cortes) en:
 *      - results.json  (detalle completo, fuente de verdad)
 *      - results.csv   (resumen para vista rapida)
 *
 *  Es REANUDABLE: si se corta, al volver a ejecutarlo continua donde quedo.
 *
 *  Uso (ver READ_ME.txt):   node audit.js
 * ==========================================================================*/
...
const SALIDA_JSON     = 'results.json';
const SALIDA_CSV      = 'results.csv';
...
(async () => {
  ...
  // Reanudacion: cargar results previos y saltar los ya hechos con exito
  let previos = [];
